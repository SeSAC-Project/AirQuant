  ...
  return (
    <div className="Bubble_">
      <div className="Bubble_container">
        <section
          className="Bubble_container_section1"
          data-aos="fade-up"
          data-aos-anchor-placement="top-bottom"
          data-aos-offset="150"
        >
          <img
            className="Bubble_container_section1_img"
            src={airquant_human1}
            alt=""
          />
        ...
        <section
          className="Bubble_container_section2"
          data-aos="fade-up"
          data-aos-anchor-placement="top-bottom"
          data-aos-offset="150"
        >
          <img
            className="Bubble_container_section1_img2"
            src={airquant_human2}
            alt=""
          />
        ...
        <section
          className="Bubble_container_section3"
          data-aos="fade-up"
          data-aos-anchor-placement="top-bottom"
          data-aos-offset="150"
        >
