<p align="center">
<img src="https://user-images.githubusercontent.com/68809452/214257113-05e9e78a-0c83-415d-ada1-b8f5fc37a2da.png" alt="pick-git-logo" width="100" height="100">
</p>
<div align="center">
  
(주)파이퀀트의 제품 에어퀀트 제품 소개 및 홍보 웹사이트 제작</br>
🌏 [Airquant](https://main.d2tfxbeyfu5as6.amplifyapp.com/)
</div>
<div align="center">
  
<a href="https://www.notion.so/2dbeed4c2e684fcd86fff264b48b22fb"><img src="https://img.shields.io/badge/Notion-%23000000.svg?style=for-the-badge&logo=notion&logoColor=white&link=https://balanced-desk-3a4.notion.site/EYAGI-06e6113484324fe8ba37ec83e5e70b8d/"/></a>
</div>
...
<table>
  ...
  <tr align="center">
    <td><img src="https://user-images.githubusercontent.com/68809452/214257901-2a2a4e2c-b9f6-46f1-a225-7a5208693bb9.png" width="150px"/></td>
...
<img src="https://img.shields.io/badge/Sass-ff69b4?style=&logo=Sass&logoColor=white"/> 
<br />
...
- header, top 버튼 : useState를 사용하여 설정한 scroll 값 위치 시 상태 및 스타일링 변경
...
## <strong>1. 팀 계정 배포</strong>

### **`문제`**

1. 팀 계정 배포는 유료
2. 배포 후 firebase로 데이터가 전송되지 않음
3. 구글맵이 제대로 출력안됨
...
처음 팀프로젝트를 하면서 협업툴로 깃허브를 모두 처음 사용하는 상황
...
페이지마다 들어가는 모션이 다르고, 구현해야 하는 애니메이션의 디테일이 달랐음

### **`원인`**

원하는 리액트 애니메이션을 넣으려고 자료조사를 해보니, 원하는 애니메이션이 없었음

### **`해결`**

- 공통으로 들어가는 요소인 header와 top button은 useState를 이용하여 스크롤 값에 따른 상태 변화 스타일링을 적용
- 여러 정보 콘텐츠가 들어가는 본문의 경우 Aos (Animate on Scroll) Library를 사용하여 일관되고 통일성 있는 애니메이션 적용
- 본문 중 횡으로 들어오는 스크롤의 경우 커스텀 훅으로 제작하여 해당 요소가 화면 높이값에 절반에 위치할 때 애니메이션이 동작하도록 기능 구현
